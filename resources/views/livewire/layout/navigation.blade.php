            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.scholarships.index')" :active="request()->routeIs('admin.scholarships.index')" wire:navigate>
                            {{ __('All Scholarships') }}
                        </x-nav-link>
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('student.scholarships.index')" :active="request()->routeIs('student.scholarships.index')" wire:navigate>
                            {{ __('Available Scholarships') }}
                        </x-nav-link>
                        <x-nav-link :href="route('student.scholarships.applications')" :active="request()->routeIs('student.scholarships.applications')" wire:navigate>
                            {{ __('My Applications') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('student.scholarships.index')" :active="request()->routeIs('student.scholarships.index')" wire:navigate>
                    {{ __('Available Scholarships') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('student.scholarships.applications')" :active="request()->routeIs('student.scholarships.applications')" wire:navigate>
                    {{ __('My Applications') }}
                </x-responsive-nav-link>
            @endif
        </div>
