            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(auth()->check() && auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.grades.upload')" :active="request()->routeIs('admin.grades.*')">
                            {{ __('Grade Evaluation') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->check() && auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.grades.upload')" :active="request()->routeIs('admin.grades.*')">
                    {{ __('Grade Evaluation') }}
                </x-responsive-nav-link>
